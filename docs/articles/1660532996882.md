...
花了大量时间整理的前端知识手册，内容由浅到深，主要是笔者的前端知识复盘合集，干货满满，分享出来一起交流进步，同样适合各个阶段的前端人学习和巩固，面试备战。另个人知识水平有限，如有纰漏，望不吝指正。
...
- Get 通过 **URL** 编码传输数据，Post 通过 **body** 传输，支持多种编码格式（两者都是**明文传输**，都不是安全的）
