...
我们都知道前端体系领域广，知识又碎片化，因此我比较喜欢将零碎的知识点记录汇总起来，首先记录的所学所思可方便日后复习，在这个过程中也能不断深入和强化理解，而且最终文章的目录会自然地形成一个知识脉络的树形图（对于我这种不会画思维导图的人来说，这种自下而上的方式更合适），所以本文也不会覆盖到前端的方方面面，只会记录一些个人认为重要的知识点，以及面试中高频的问题。
...
要我说es6继承最有实战意义，但要真想搞懂继承，还得继续往下看，首先JS继承到底有哪几种？摊开手掌✋往前一摆：
...
为什么经典排序只说这两种，首先冒泡是相对比较简单的一种排序方法，然后插入和冒泡稳定性都比较高，两者时间复杂度都是O(n²)。
