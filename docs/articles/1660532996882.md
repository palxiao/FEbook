...
我们都知道前端体系领域广，知识又碎片化，因此我比较喜欢将零碎的知识点记录汇总起来，首先记录的所学所思可方便日后复习，在这个过程中也能不断深入和强化理解，而且最终文章的目录会自然地形成一个知识脉络的树形图（自下而上的方式更合适学习，如果需要整理成体系还是推荐思维导图），所以本文可能也不会覆盖到前端的方方面面，主要方便个人知识点梳理以及复习，涉及面试中高频的问题、常见前端问题等。另个人知识水平有限，如有纰漏，望不吝指正。
