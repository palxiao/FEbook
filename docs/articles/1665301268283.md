...
> 注意：码云开启Pages需要实名认证，如果第一次实名认证大概要**一个工作日**时间审核

个人体验下来 **Github** 的访问速度比码云**更快**，当然有被墙的风险，我是绑定了自己的域名并加了一层腾讯云免费**CDN**，应该还是比较稳定的，另外**码云**还不能自定义域名，居然要收钱。。关键访问速度本就差强人意。。![](../images/0.5618178417111541.png)
