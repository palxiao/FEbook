...
答案是后两者都会使**移动端的图片变模糊**！起初我发现图片在手机上模糊的问题时，调试很久都没定位到源头，一筹莫展之际想起以前做H5网页常使用 **vant** 框架，就想要不看看它的源码中的图片预览组件吧，很快我找到[相关代码位置](https://github.com/youzan/vant/blob/main/packages/vant/src/image-preview/ImagePreviewItem.tsx)，代码截图：
