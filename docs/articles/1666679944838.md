...
答案是后两者都会使**移动端的图片变模糊**！起初我发现图片在手机上模糊的问题时，调试很久都没定位到源头，一筹莫展之际想起以前做图片预览都是使用 **vant**，那就看看它的源码吧：[相关代码位置](https://github.com/youzan/vant/blob/main/packages/vant/src/image-preview/ImagePreviewItem.tsx)，代码截图：
