...
低代码：主要面向开发人员（特别是对前端不熟悉的开发），通过自动代码生成和可视化编程，旨在使用少量代码，快速搭建页面。低代码既要考虑一定的易用性，也要充分保证灵活性、可扩展性(代码增强)，这种混合开发能够基本满足具有较复杂场景交互的应用。

总的来说，低代码的核心即是把大部分常规工作交给程序去完成，而业务开发人员则负责“**走完最后的一公里路**”。
